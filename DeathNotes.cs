...
namespace Oxide.Plugins
{
    ...
    class DeathNotes : RustPlugin
    {
        ...
        // additional tags for styling responses, etc
        ...
        //  --> Handles permissions across user auth
        ...
        bool UseSimpleUI;
        // --> Need to dig into NPC functionality
        bool SnowNpcBattles;
        ...
        class UIObject
        {
            ...
            string RandomString()
            {
                ...
                // --> Looks like we have access to all UnityEngine classes, this could
                //      be very very huge.
        ...
        // PlayerSettings
        //  class to hold set/get the player settings
        //  public: ui
        //  public: chat
        ...
        // Attacker
        //  class to define, set/get the player data from
        //  those who killed the last player.
        class Attacker
        {
            ...
            // Attempt to get the name of the player that
            // killed the active player.
            public string TryGetName()
            {
                // if there's no entity, define
                // as "No Attacker"
                if (entity == null)
                    return "No Attacker";
                ...
                if (type == AttackerType.Self)
                    return "themselves";
                // handle animal type, and then conditionally
                ...
                // handle all of the structural kills, 
                // like barricades, high walls, etc
            ...
            // true to define and get the type of the attacker
            // then use that type to define who the attacker
            // was.
        ...
        // Victim
        //  class to define the victim of the attack
        //  and to set relevant meta data
        //
        //  public: name {string}
        //  public: entity {BaseCombatEntity}
        //  public: type {VictimType}
        class Victim
        {
            public string name = string.Empty;
            [JsonIgnore]
